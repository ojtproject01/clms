...
function sidebarColor(a) {
  ...
  var dashboardCard = document.querySelector('#carddashboardIcon');
  dashboardCard.setAttribute("data-color", color);
  ...
  if (document.querySelector('#sidenavCard')) {
    ...
    // var carddashboardIcon = document.querySelector('#carddashboardIcon');
    // let carddashboardIconClasses = ['icon', 'icon-shape', 'shadow', 'text-center', 'border-radius-md', 'bg-gradient-' + color];
    // carddashboardIcon.className = '';
    // carddashboardIcon.classList.add(...carddashboardIconClasses);
  }
